...
void stabilizerInit(void)
{
  ...
  DEBUG_PRINT(" motors initialization over.\n");
  imu6Init();
  DEBUG_PRINT(" imu initialization over.\n");
  sensfusion6Init();
  DEBUG_PRINT(" sensor fusion initialization over.\n");
  controllerInit();
  DEBUG_PRINT(" controller initialization over.\n");
#if defined(SITAW_ENABLED)
  sitAwInit();
  DEBUG_PRINT(" sitAw initialization over.\n");
#endif
